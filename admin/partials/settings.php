...
<div class="wrap wphm-wrap">
	...
	<h1 class="wphm-page-title"><?php esc_html_e( 'Settings', 'wp-help-manager' ); ?></h1>
	...
	<div class="wphm-settings-tabs">
		<div class="inner">
			...
			<a <?php if( $tab === 'tools' ) echo 'class="active" ';?>href="admin.php?page=wp-help-manager-settings&tab=tools">
				<?php esc_html_e( 'Import/Export', 'wp-help-manager') ?>
			</a>
		</div>
	</div>
		...
		<?php } elseif( $tab === 'tools' ) { ?>
			...
			<div class="wphm-docs-row wphm-settings-row">
				...
				<div class="wphm-settings-box wphm-settings-box-import">
					...
					<div class="wphm-settings-box-inside">
						<form action="">
							<p><?php esc_html_e( 'Select the WP Help Manager .json file you would like to import. When you click the import button below, WP Help Manager will import the help documents.', 'wp-help-manager' ); ?></p>

							<div class="form-field form-field-highlight">
								<div>
									<label for="wphm-import">
										<?php esc_html_e( 'Select file', 'wp-help-manager' ); ?>
									</label>
									<input type="file" id="wphm-import" name="wphm-import">
								</div>
							</div>

							<div class="form-field form-field-submit">
								<div>
									<input class="button button-primary" type="submit" value="<?php esc_attr_e( 'Import File', 'wp-help-manager' ); ?>">
								</div>
							</div>
				...
				<div class="wphm-settings-box wphm-settings-box-import">
					...
					<div class="wphm-settings-box-inside">
						<form action="">
							<p><?php esc_html_e( 'Select help documents you would like to export and then select your export method. Use the download button to export to a .json file which you can then import to another WP Help Manager installation.', 'wp-help-manager' ); ?></p>
							...
							<div class="form-field form-field-flex form-field-radio form-field-highlight">
								...
								<div class="full">
									...
									if( $docs ) {
										...
										?>
											<div>
												<input type="checkbox" id="<?php echo $document->ID; ?>" name="<?php echo $document->ID; ?>" value="<?php echo get_the_title( $document ); ?>">
